...
└─ references/
   ...
   ├─ naver-format.md
   ├─ revision-rubric.md
   ├─ reference-reading-methods.md
   └─ geukak-seosaeng-craft.md
```
...
- `reference-reading-methods.md`: 레퍼런스 독해 기반 작법 분석
- `geukak-seosaeng-craft.md`: 극악서생 9개 파일 독해 기반 몰입·말투·전개 기술 분석
